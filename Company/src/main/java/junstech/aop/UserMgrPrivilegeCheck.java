...
@Aspect
public class UserMgrPrivilegeCheck {

	public UserMgrPrivilegeCheck() {

	}

	@Pointcut("execution(* junstech.collab.mgr.user.*.*(..))")
	...
	public void doAccessCheck() throws LoginException, PrivilegeException {
		...
		CommonMethod.checkPrivilege(attr, session, MetaData.UserMgrModule);	
	}
