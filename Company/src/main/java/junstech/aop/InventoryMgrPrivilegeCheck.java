...
@Aspect
public class InventoryMgrPrivilegeCheck {

	public InventoryMgrPrivilegeCheck() {

	}

	@Pointcut("execution(* junstech.collab.mgr.inventory.*.*(..))")
	...
	public void doAccessCheck() throws LoginException, PrivilegeException {
		...
		CommonMethod.checkPrivilege(attr, session, MetaData.InventoryMgrModule);	
	}
