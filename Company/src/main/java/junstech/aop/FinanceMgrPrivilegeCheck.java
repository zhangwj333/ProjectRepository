...
@Aspect
public class FinanceMgrPrivilegeCheck {

	public FinanceMgrPrivilegeCheck() {

	}

	@Pointcut("execution(* junstech.collab.mgr.finance.*.*(..))")
	...
	public void doAccessCheck() throws LoginException, PrivilegeException {
		...
		if (url.contains("query") || url.contains("summary")) {
			for (Privilege privilege : user.getPrivileges()) {
				if (privilege.getProgramid() == MetaData.FinanceMgrModule) {
