...
@Aspect
public class PurchaseMgrPrivilegeCheck {

	public PurchaseMgrPrivilegeCheck() {

	}

	@Pointcut("execution(* junstech.collab.mgr.purchase.*.*(..))")
	...
	public void doAccessCheck() throws LoginException, PrivilegeException {
		...
		CommonMethod.checkPrivilege(attr, session, MetaData.PurchaseMgrModule);	
	}
